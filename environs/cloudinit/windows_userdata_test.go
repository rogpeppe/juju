...
// Note that the data below has been processed to:
// - quote all regexp metacharacters
// - change backquotes to dots
// - remove the agent config output, as it's sensitive
//    to YAML rendering behaviour.
// TODO It would be better to include much less
// of this.
